...
uint8_t text_buff[RH_RF95_MAX_MESSAGE_LEN];   // Buffer for text input
...
void command_parser() { 
  String input = (char*)text_buff;              // Get our text into a string so we can easily manipulate it
...
void setup() {
  ...
  rf95.setFrequency(434.875);                                           // Set to an open auxiliary frequency
